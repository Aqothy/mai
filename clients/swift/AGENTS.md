...
- use your native edit and read tools over these: `XcodeRead`, `XcodeWrite`, `XcodeUpdate`

DO NOT EDIT xcodeproj or any autogenerated files, let the user know if you need
a change in those files
